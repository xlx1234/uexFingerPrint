...
public class EUExDemo extends EUExBase {
    ...
    private static final String TAG = "uexFingerPrint";
    private static final String CALLBACK_ON_VIEW_BUTTON_CLICK = "uexFingerPrint.onViewButtonClick";
    private static final String CALLBACK_ON_FRAGMENT_BUTTON_CLICK = "uexFingerPrint.onFragmentButtonClick";
